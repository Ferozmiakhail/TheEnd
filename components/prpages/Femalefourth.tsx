...
<div className="product-detail-desc fonpriallchange">
<h1 className="changeallname">{name}</h1>
...
<div className="maylike-products-container track">
 {products.map((item) => (
   item.productcategory === "Femalefourth"? <Product key={item._id}
   image={item.image}
   name={item.name}
